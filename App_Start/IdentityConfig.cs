...
{
    //Configure the application user manager and roles manager used in this application. 
    //UserManager and roleManager is defined in ASP.NET Identity and is used by the application.
