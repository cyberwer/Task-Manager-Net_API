namespace DentalDDS_Api.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ErrorStackTrace = c.String(maxLength: 500),
                        ErrorInnerException = c.String(maxLength: 500),
                        ActionMethod = c.String(maxLength: 50),
                    })
                ...
                c => new
                    {
                        ...
                        MobilNumber = c.String(nullable: false),
        ...
        {
            DropForeignKey("dbo.UserProfile", "UserProfileID", "dbo.AspNetUsers");
